...
class NewsletterFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'project' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_bin', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-08-14 05:35:44',
                'modified' => '2019-08-14 05:35:44'
            ],
        ];
        parent::init();
    }
